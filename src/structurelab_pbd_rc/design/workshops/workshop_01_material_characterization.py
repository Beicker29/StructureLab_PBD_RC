...
def build_mander_unconfined_memory_lines(model_report: dict[str, Any]) -> list[str]:
    ...
    lines = [
        ...
        "",
        f"Taller: {model_report['workshop_id']} - {model_report['title']}",
    ...
    lines.extend(
        [
            ...
            "- YAML del modelo: outputs/workshop_01/reports/mander_classic_unconfined_concrete/mander_classic_unconfined_concrete.yaml",
            "- Figura del modelo: outputs/workshop_01/figures/models/mander_classic_unconfined_concrete.png",
            "- Datos CSV/XLSX: outputs/workshop_01/data/models/mander_classic_unconfined_concrete/",
        ]
    )
    return lines
...
def build_mander_unconfined_quarto_document(model_report: dict[str, Any]) -> str:
    ...
    workshop_title = "Caracterización mecánica monotónica de materiales"
...
Esta memoria resume el modelo constitutivo de Mander clásico para concreto no confinado usado en el Taller 1.
Los valores mostrados se consumen desde el archivo YAML del modelo ya calculado; esta memoria no recalcula parámetros.

- **Taller:** Taller 1.
- **Nombre del taller:** {workshop_title}.
...
- Archivo de entrada: `configs/workshops/workshop_01_material_characterization.yaml`
- Archivo de resultados del modelo: `outputs/workshop_01/reports/mander_classic_unconfined_concrete/mander_classic_unconfined_concrete.yaml`
- Datos de la curva en formatos CSV y XLSX: `outputs/workshop_01/data/models/mander_classic_unconfined_concrete/`
- Figura de la curva: `outputs/workshop_01/figures/models/mander_classic_unconfined_concrete.png`
"""
...
def build_calculated_parameters_report(
    ...
    *,
    ...
    return {
        ...
        "title": config["title"],
        "source_inputs": "configs/workshops/workshop_01_material_characterization.yaml",
        "units": config["units"],
        "input_data": {
                "title": "Datos de entrada",
                "description": "Datos leidos desde el YAML del Taller 1 antes de calcular parametros derivados.",
                "data": {
                    "section": {
...
def run(
    ...
    This workflow reads inputs, calls mechanics models and exports organized
    workshop artifacts.
    """
    ...
    for old_global_report in (
        reports_dir / "workshop_01_calculated_parameters.yaml",
        reports_dir / "workshop_01_report.pdf",
    ):
