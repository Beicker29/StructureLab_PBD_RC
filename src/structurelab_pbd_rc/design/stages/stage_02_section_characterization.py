"""Flujo de Etapa 2: caracterizacion de seccion por diagrama M-phi."""
...
DEFAULT_CONFIG_PATH = Path("configs/stages/stage_02_section_characterization.yaml")
...
def validate_stage_02_config(config: dict[str, Any]) -> None:
    """Validate the editable structure required by Etapa 2."""
...
def run(
    ...
    for sheet_name in sheet_names:
        ...
        sheet_results_path = sheet_dirs["data"] / "stage_02_sheet_results.json"
        sheet_payload = {
            "stage_id": config["stage_id"],
            "title": config["title"],
            "sheet": sheet_name,
