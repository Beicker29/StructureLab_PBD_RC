...
La Etapa 2 usa diagramas momento-curvatura para obtener una idealizacion bilineal equivalente de la respuesta seccional.

## Entrada

El archivo de entrada se define en `configs/stages/stage_02_section_characterization.yaml`.
...
Cada hoja se procesa como un diagrama independiente. En cada ejecucion se borra la salida previa de `outputs/stage_02/` y se reconstruyen las carpetas de las hojas del Excel vigente.
...
La Etapa 2 genera un indice agregado y una subcarpeta por hoja:
