"""Geometry tests for Etapa 1."""

from pathlib import Path

from structurelab_pbd_rc.io.read_config import load_yaml_config
from structurelab_pbd_rc.design.stages.stage_01_material_characterization import build_geometry_and_confinement


def test_stage_01_geometry_is_positive() -> None:
